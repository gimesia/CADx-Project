...
class LesionClassifier(nn.Module):
    def __init__(self, num_classes=1, frozen_layers=3, dropout=0.3):
...
FROZEN_LAYERS = 3
model = LesionClassifier(num_classes=1, frozen_layers=0)
...
dl = MLFlowDLPipeline(model, optimizer, criterion, train_loader, val_loader,
                      f"EfficientNet_V2_M_{FROZEN_LAYERS}-frozen-layers")
