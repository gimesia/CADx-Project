...
# Step 1: Define the base class for preprocessing steps
class PreprocessingStep:
    def apply(self, image: np.ndarray) -> np.ndarray:
        raise NotImplementedError("This method should be overridden in the derived class.")


# Step 2: Implement concrete preprocessing steps
...
# Step 3: Implement the factory class to add and manage preprocessing steps
